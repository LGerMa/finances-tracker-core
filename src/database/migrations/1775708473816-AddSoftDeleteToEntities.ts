...
export class AddSoftDeleteToEntities1775708473816 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "recurring_entries" ADD "deleted_at" TIMESTAMP`,
    );
    await queryRunner.query(`ALTER TABLE "income" ADD "deleted_at" TIMESTAMP`);
    await queryRunner.query(
      `ALTER TABLE "expenses" ADD "deleted_at" TIMESTAMP`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "recurring_entries" DROP COLUMN "deleted_at"`,
    );
